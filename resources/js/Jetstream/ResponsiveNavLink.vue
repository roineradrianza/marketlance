...
<script>
    ...
    export default defineComponent({
        ...
        computed: {
            classes() {
                return this.active
                    ? 'block pl-3 pr-4 py-2 border-l-4 border-base-100 text-base font-bold text-base-200 focus:outline-none focus:text-base-100 focus:border-base-300 transition'
